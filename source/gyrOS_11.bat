...
:: Configure Variables
set "currentuser=%WinDir%\gyrOS\MinSudo\MinSudo.exe --nologo --"
...
reg add "HKCR\regfile\Shell\RunAs\Command" /ve /t REG_SZ /d "%WinDir%\gyrOS\MinSudo/MinSudo --trustedinstaller --nologo reg import "%%1"" /f > nul 2> nul
