...
:: Default gyrOS 22H2 Services Configuration
...
%currentuser% reg add "HKLM\SYSTEM\CurrentControlSet\Services\TrkWks" /v "Start" /t REG_DWORD /d "4" /f
:: Services Configured from NTLite
